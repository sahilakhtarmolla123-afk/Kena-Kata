...
export const STATE_DISTRICTS: Record<typeof INDIAN_STATES[number], string[]> = {
  ...
  "Jammu & Kashmir": [
    ...
    "Kishtwar", "Kulgam", "Kupwara", "Mendhar", "Poonch", "Pulwama", "Ramban", "Reasi",
  ...
  "Odisha": [
    ...
    "Kandhamal", "Kendrapara", "Kendujhar", "Khorda", "Koraput", "Malkangiri", "Mayurbhanj",
